    ...
    <div className="py-10 mx-4">
      <div className="w-11/12 text-center mx-auto">
        <div>
          ...
          <p className="text-1xl lg:w-11/12 mx-auto font-light">
                  ...
                  {testimonials.map((item, index) => (
                    <div
                      ...
                      <div className="p-5">
                        ...
                        />
                        {item.categories[0] === 9 && (
                          <p className="text-gray-500 text-sm text-wrap whitespace-normal">
                        ...
                        <p
                          className="py-3 font-light text-gray-800 text-[14px] lg:h-[190px] xl:h-[190px] md:h-[190px] sms:h-[190px] text-wrap sxs:h-[300px] whitespace-normal"
                          dangerouslySetInnerHTML={{
