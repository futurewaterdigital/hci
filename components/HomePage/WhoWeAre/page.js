...
export default function WhoWeAre() {
  return (
    <div className="mt-0 flex flex-col justify-center items-center text-center">
      ...
      <div className="md:grid lg:w-5/6 xl:w-4/6 mx-auto lg:h-56 lg:grid grid-cols-2 rounded-3xl group my-12 p-4 lg:p-0 lg:shadow">
        <div className="lg:h-56 text-start md:text-right lg:text-right p-4 bg-[#F1F8FF] transition-colors duration-300 ease-in-out group-hover:bg-[#D84498] lg:rounded-l-3xl md:rounded-l-3xl">
        ...
        <div className="lg:h-56 text-left p-4 bg-[#D84498] transition-colors duration-300 ease-in-out group-hover:bg-[#F1F8FF] lg:rounded-r-3xl md:rounded-r-3xl ">
