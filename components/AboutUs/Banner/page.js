...
function Banner() {
  return (
    <div className="relative h-[100vh]">
      <div className="absolute inset-0 bg-center  bg-no-repeat bg-[url('/mobile/about-us-banner.png')] bg-cover lg:hidden"></div>
      <div className="absolute inset-0 bg-right  bg-no-repeat bg-[url('/images/about-us-banner.png')] bg-cover hidden lg:block"></div>
