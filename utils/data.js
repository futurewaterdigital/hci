...
export const menu = [
  ...
  { options: "Our Services", url: "/our-services" },
  { options: "Cost Comparison", url: "/cost-comparison" },
...
export const footerMenu = [
  {
    ...
    links: [
      ...
      {
        name: "Benign Peripheral Nerve Tumour",
      ...
      {
        name: "Brain Tumour and Brain Cancer",
        url: "/treatment/neuro-sciences/brain-tumour-and-brain-cancer",
      },
      {
        name: "By-Pass Surgery (CABG)",
    ...
    section: [
      ...
      // },
      {
        ...
        links: [
          ...
          { name: "Request an Appointment", url: "/?scrollTo=form" },
        ],
      },
    ],
  },
...
export const valueHCI = [
  ...
  },
  {
    title: "Compassion",
    excerpt:
      "We are concerned about the patient’s well-being and work in their best interests at all times. We are empathetic to the patient’s point of view and offer advice that works best in his/ her interest.",
  },
  {
    title: "Integrity",
    excerpt:
