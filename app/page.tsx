...
export default function Home() {
 ...
 const itemListSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": {
          ...
          "description": "Healthcare International (HCI) is your trusted partner, supporting you at every stage of your medical journey.",
          "publisher": {
            "@type": "Organization",
            "name": "Healthcare International",
            "sameAs": "https://www.healthcareinternational.in"
      ...
      },
      {
        ...
        "item": {
          ...
          "name": "HCI Contact Us",
          "description": "Healthcare International is committed to building a strong, dependable healthcare universe that supports both patients and partners.",
          "publisher": {
            "@type": "Organization",
            "name": "Healthcare International",
            "sameAs": "https://www.healthcareinternational.in"
  ...
  return (
    <main>
      {/* Pretty-printed JSON-LD for FAQs */}
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([itemListSchema, faqSchema], null, 2),
        }}
      />
      <Header />
      <Banner />
