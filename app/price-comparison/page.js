      ...
      <div className="container mx-auto p-6">
        ...
        <section className="container mx-auto px-6">
          ...
          <p className="mb-8 font-light">
            ...
            Thailand and 13,000 in Singapore, but 6,500 in India. Similarly, in
            the US for a bone marrow transplant you will have to pay around
            400,000; in the UK 150,000; but in India it will cost just 30,000.
            No matter what treatment you opt for, you are going to save around
            70-75% of the total cost including health or medical services,
            wellness travel, accommodation and food services.
          </p>
          <p className="mb-8 font-light">
