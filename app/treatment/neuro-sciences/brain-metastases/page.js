    ...
    <>
      ...
      <div className="lg:container mx-auto space-y-4 px-6 lg:px-0">
        ...
        <ul className="list-disc list-inside ml-2 text-hciSecondary">
          <li>
            <span className=" text-black">Lung cancer</span>
          </li>
          <li>
            <span className=" text-black">Kidney cancer</span>
          </li>
          <li>
            <span className=" text-black">Melanoma</span>
          </li>
          <li>
            <span className=" text-black">Breast cancer</span>
          </li>
          <li>
            <span className=" text-black">Colon cancer</span>
          </li>
        </ul>
