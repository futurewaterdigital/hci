  ...
  complications: [
    {
      ...
      aneurysmSymptoms: [
        {
          description:
            '<span className="font-semibold text-hciSecondary">Evaluation:</span> A comprehensive assessment of your overall health, joint condition, and lifestyle to ensure surgery is the best option.',
        },
        {
          description:
            '<span className="font-semibold text-hciSecondary">Prehabilitation:</span> Some patients undergo physical therapy before surgery to strengthen muscles and improve flexibility, aiding in recovery.',
        },
      ],
    },
    {
      ...
      aneurysmSymptoms: [
        {
          description:
            '<span className="font-semibold text-hciSecondary">Hip Replacement:</span> Involves replacing the ball and socket of the hip joint with prosthetic components.',
        },
        {
          description:
            '<span className="font-semibold text-hciSecondary">Knee Replacement:</span> The damaged surfaces of the knee joint are replaced with metal and plastic components.',
        },
        {
          description:
            '<span className="font-semibold text-hciSecondary">Shoulder and Elbow Replacement:</span> These procedures involve replacing the damaged joint surfaces with artificial implants to restore function and reduce pain.',
        },
      ],
    },

    {
      ...
      aneurysmSymptoms: [
        {
          description:
            "Cemented and Cementless Implants: In some cases, the implant is fixed to the bone using a special bone cement, while in others, the bone is allowed to grow into the implant for natural fixation.",
        },
      ],
    },

    {
      ...
      aneurysmSymptoms: [
        {
          description:
            '<span className="font-semibold text-hciSecondary">Physical Therapy:</span> Rehabilitation is crucial for regaining strength, mobility, and function in the replaced joint. A customized exercise programme is typically provided.',
        },
        {
          description:
            '<span className="font-semibold text-hciSecondary">Pain Management:</span> Medications and therapies are used to control pain after surgery, ensuring comfort and promoting recovery.',
        },
        {
          description:
            '<span className="font-semibold text-hciSecondary">Follow-up Appointment:</span> Regular check-ups with the surgeon to monitor healing and the function of the artificial joint.',
        },
      ],
    },
  ],
  ...
  return (
    ...
    <>
      ...
      <div className="lg:container mx-auto space-y-4 px-6 lg:px-0">
        ...
        <H2
          title="Causes Leading to Joint Replacement Surgery"
          className="text-2xl font-medium mb-4 text-center"
        />
        <p className="font-light">
          Several conditions can lead to the need for joint replacement surgery,
          including:
        </p>
        <ListBox data={data} />
