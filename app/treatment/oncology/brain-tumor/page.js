...
const tumorTumorOptions = [
  {
    title: "Craniotomy:",
    description:
      "the temporary removal of a piece of skull to allow surgeons access to the brain",
  },
  {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="my-10">
        ...
        <p className="mt-4 text-gray-600 text-start w-full text-lg mx-auto font-light leading-relaxed">
          ...
          of the brain. Some examples of malignant tumors that originate in or
          near the brain include olfactory neuroblastoma, chondrosarcoma and
          medulloblastoma.
        </p>
      </div>
      ...
      <p className="mt-4 text-gray-600 text-start w-full text-lg mx-auto font-light leading-relaxed">
        ...
        four times more common than primary brain tumors. They can grow rapidly,
      ...
      <p className="mt-4 text-gray-600 text-start w-full text-lg mx-auto font-light leading-relaxed">
        ...
        (e.g., glioblastoma multiforme), gliomas, ependymomas and
        medulloblastomas.
      </p>
      <div className="text-center my-5 underline">
        <a className="text-lg text-[#0E56A0] text-bold " href="">
      ...
      <div className="flex gap-2 flex-col md:flex-row my-10">
        ...
        <div className="flex-1">
          ...
          <p className="mt-4 text-gray-600 text-start w-full text-sm mx-auto font-light leading-relaxed">
            ...
            head may cause trouble with movement, walking, balance and
      ...
      <div className="my-10 p-4 font-sans">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          ...
          <div className="md:w-1/2 bg-[#FFE7B6] p-4 rounded-md shadow">
            ...
            <p className="text-gray-700 mb-4">
              Genetics are to blame for a small number (fewer than 5%) of brain
              tumors. Some inherited conditions put individuals at greater risk
            ...
            <ul className="list-disc pl-8 space-y-2  marker:text-pink-500">
              ...
              <li className="text-gray-700">Familial adenomatous polyposis</li>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">
                    ...
                    identify the tumor, pinpoint its location and/or assess the
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">
                    ...
                    collection and analysis), they will diagnose the brain tumor
                    and plan the treatment based on other test results. If a
                    biopsy was possible, doctors can use it to determine the
                    tumor grade (how aggressive it is), as well as study the
                    tumor tissue for any biomarkers that can help personalize
      ...
      <p className="mt-4 text-gray-600 text-start w-full text-lg mx-auto font-light leading-relaxed">
        ...
        radiosurgery and proton therapy are some of the radiation treatments for
        brain tumor.
      </p>
      ...
      <p className="mt-4 text-gray-600 text-start w-full text-lg mx-auto font-light leading-relaxed">
        ...
        pioneered different ways to get chemotherapy drugs into the brain,
        including surgically implanted wafers such as Gliadel. To mop up any
        lingering cancer cells, surgeons use these wafers to line the area left
        behind after a tumor is removed.
      </p>
      ...
      <p className="mt-4 text-gray-600 text-start w-full text-lg mx-auto font-light leading-relaxed">
        ...
        side effects. These drugs are most often used to treat metastatic brain
        tumors and are frequently paired with other therapies like surgery or
        radiation.
      </p>
      ...
      <p className="mt-4 text-gray-600 text-start w-full text-lg mx-auto font-light leading-relaxed">
        ...
        device can cause local side effects, such as scalp irritation, and
        requires frequent head shaving.
      </p>
      ...
      <p className="mt-4 text-gray-600 text-start w-full text-lg mx-auto font-light leading-relaxed">
        ...
        safe and more effective than existing therapies. Brain tumor clinical
        trials are frequently focused on finding new ways to manage malignant
        brain tumors.
      </p>
      ...
      <p className="mt-4 text-gray-600 text-start w-full text-lg mx-auto font-light leading-relaxed">
        ...
        successful your personal outcome will be depends on many factors,
        including:
      </p>
