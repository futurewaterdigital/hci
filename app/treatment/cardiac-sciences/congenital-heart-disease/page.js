      ...
      <main className="lg:container mx-auto py-8 px-6">
        <section className="space-y-4">
          ...
          <p className="text-gray-700 mb-6 font-light">
            ...
            and arteries. The two primary categories of CHD are{" "}
            <strong className="text-black font-medium">cyanotic CHD </strong>
            (low oxygen levels in the blood) and{" "}
            <strong className="text-black font-medium">
              acyanotic CHD
            </strong>{" "}
            (where oxygen levels remain normal, but the heart&apos;s function is
            impaired).
          </p>
        </section>
        ...
        <div>
          ...
          <p className="font-light py-4">
            Complications from treatment may include bleeding, infection,
            arrhythmias, or scar tissue formation. Recovery time varies based on
            the procedure, with some patients needing several days to months for
            full recovery.
          </p>
        </div>
